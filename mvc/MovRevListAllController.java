...
@WebServlet("/movRevListAll.do")
public class MovRevListAllController extends HttpServlet {
	...
	public void doUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MovDTO> rv = mvd.dbRevSelectAll(start, end, skey, sval);
    ...
    request.setAttribute("sval", sval);
		...
		RequestDispatcher dis = request.getRequestDispatcher("Mov_RevListAll.jsp");
